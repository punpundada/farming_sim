...
var animation_states = {
	GameInputEvents.Direction.UP: "tilling_back",
	GameInputEvents.Direction.DOWN: "tilling_front",
	GameInputEvents.Direction.LEFT: "tilling_left",
	GameInputEvents.Direction.RIGHT: "tilling_right"
}
